...
let newEuros = calculateExchange (euroRate / danishAmount);
let newDollars = calculateExchange (dollarRate / danishAmount);

showResult(newEuros, newDollars, danishAmount);
}
